...
barrel / nose / gun — infantry are too symmetric to read.

Modes:
  python verify_facing.py crusader                 # frames 0,2,4,6 of one key
  python verify_facing.py crusader --frames 0-7     # all 8, in order
